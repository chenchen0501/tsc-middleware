...
TSC-Print-Middleware 是一个**零驱动 USB 打印中间件**，专为 **TSC 热敏标签打印机**设计。基于 **Python** 和 **FastAPI** 构建，提供 **RESTful API** 实现**模板化标签打印**，支持**文本**、**条形码**和**二维码**。无需安装驱动程序，通过 **USB** 直接通信。适用于 **Windows** 平台的**仓库管理**、**库存系统**、**物流自动化**和**资产标签**打印场景。
